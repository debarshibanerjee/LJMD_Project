...
extern void force_with3LawN(mdsys_t *sys);
...
//extern void verlet_vel_update(const double * factor, mdsys_t *sys);
//extern void verlet_vel_propagation(const double * factor, mdsys_t *sys);
